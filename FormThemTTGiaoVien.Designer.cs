...
{
	partial class FormThemTTGiaoVien
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.lblMaLoai.Text = "Tên Giáo Viên";
			// 
			// txtHoTenGiaoVien
			// 
			...
			this.txtHoTenGiaoVien.TabIndex = 4;
			// 
			// lblMaGiaoVien
			// 
